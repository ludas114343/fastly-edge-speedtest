# V12 Independent Network Auditor Verification Report
...
```json
{
  ...
  "timestamp_utc": "2026-09-22T15:27:30Z",
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 01 | 🇺🇸 美国美东 03 [edgetunnel · AWS us-east-1] | `gwgiogtgdyrqlexcdjqm.supabase.co` | `21a1f940...` | `supabase-sb2-tokyo-v5(us-east-1)` | `HTTP 204` | 1670.2 | `34.233.128.138` | `AS14618 Amazon.com, Inc.` | `US` | `US` | **PASS (MATCH)** |
| 02 | 🇫🇷 法国巴黎 02 [Wasmer · OVH AS16276] | `w-fr.ruoyemu.asia` | `78174327...` | `wasmer-edgetunnel-fr (AS16276 OVH Paris)` | `HTTP 204` | 2734.9 | `91.134.68.236` | `AS16276 OVH SAS` | `FR` | `FR` | **PASS (MATCH)** |
| 03 | 🇺🇸 美西俄勒冈 04 [Wasmer · Hetzner AS212317] | `w-us.ruoyemu.asia` | `78174327...` | `wasmer-vless-ws-test (AS212317 Hetzner Oregon)` | `HTTP 204` | 2797.1 | `5.78.138.69` | `AS212317 Hetzner Online GmbH` | `US` | `US` | **PASS (MATCH)** |
| 04 | 🇰🇷 韩国首尔 03 [edgetunnel · AWS ap-northeast-2] | `theecyezvuzkflwikxwr.supabase.co` | `21a1f940...` | `supabase-sb1-singapore-v15(ap-northeast-2)` | `HTTP 204` | 3280.9 | `15.164.219.178` | `AS16509 Amazon.com, Inc.` | `KR` | `KR` | **PASS (MATCH)** |
| 05 | 🇰🇷 韩国首尔 02 [edgetunnel · AWS ap-northeast-2] | `gwgiogtgdyrqlexcdjqm.supabase.co` | `21a1f940...` | `supabase-sb2-tokyo-v5(ap-northeast-2)` | `HTTP 204` | 3649.3 | `52.79.235.14` | `AS16509 Amazon.com, Inc.` | `KR` | `KR` | **PASS (MATCH)** |
| 06 | 🇺🇸 美国美东 02 [Wasmer · Hetzner AS213230] | `w-east.ruoyemu.asia` | `78174327...` | `wasmer-edgetunnel-us-east (AS213230 Hetzner Ashburn)` | `HTTP 204` | 2227.1 | `5.161.213.176` | `AS213230 Hetzner Online GmbH` | `US` | `US` | **PASS (MATCH)** |
| 07 | 🇸🇬 新加坡 02 [edgetunnel · AWS ap-southeast-1] | `gwgiogtgdyrqlexcdjqm.supabase.co` | `21a1f940...` | `supabase-sb2-tokyo-v5(ap-southeast-1)` | `HTTP 204` | 7069.6 | `13.214.181.238` | `AS16509 Amazon.com, Inc.` | `SG` | `SG` | **PASS (MATCH)** |
| 08 | 🇨🇦 加拿大 02 [edgetunnel · AWS ca-central-1] | `gwgiogtgdyrqlexcdjqm.supabase.co` | `21a1f940...` | `supabase-sb2-tokyo-v5(ca-central-1)` | `HTTP 204` | 1476.7 | `3.96.213.73` | `AS16509 Amazon.com, Inc.` | `CA` | `CA` | **PASS (MATCH)** |
| 09 | 🇺🇸 美国美东 01 [Northflank · GCP AS15169] | `nf-node.ruoyemu.asia` | `c69d9310...` | `northflank-singbox-lite (GCP AS396982 Council Bluffs)` | `HTTP 204` | 1431.9 | `35.232.207.236` | `AS396982 Google LLC` | `US` | `US` | **PASS (MATCH)** |
| 10 | 🇺🇸 美国美西 05 [edgetunnel · AWS us-west-1] | `theecyezvuzkflwikxwr.supabase.co` | `21a1f940...` | `supabase-sb1-singapore-v15(us-west-1)` | `HTTP 204` | 2065.8 | `54.176.70.26` | `AS16509 Amazon.com, Inc.` | `US` | `US` | **PASS (MATCH)** |
| 11 | 🇯🇵 日本东京 01 [edgetunnel · AWS ap-northeast-1] | `theecyezvuzkflwikxwr.supabase.co` | `21a1f940...` | `supabase-sb1-singapore-v15(ap-northeast-1)` | `HTTP 204` | 2893.5 | `35.78.81.70` | `AS16509 Amazon.com, Inc.` | `JP` | `JP` | **PASS (MATCH)** |
| 12 | 🇬🇧 英国伦敦 02 [edgetunnel · AWS eu-west-2] | `gwgiogtgdyrqlexcdjqm.supabase.co` | `21a1f940...` | `supabase-sb2-tokyo-v5(eu-west-2)` | `HTTP 204` | 1930.3 | `51.24.114.212` | `AS16509 Amazon.com, Inc.` | `GB` | `GB` | **PASS (MATCH)** |
| 13 | 🇩🇪 德国法兰克福 01 [edgetunnel · AWS eu-central-1] | `theecyezvuzkflwikxwr.supabase.co` | `21a1f940...` | `supabase-sb1-singapore-v15(eu-central-1)` | `HTTP 204` | 3854.0 | `63.179.112.8` | `AS16509 Amazon.com, Inc.` | `DE` | `DE` | **PASS (MATCH)** |
| 14 | 🇨🇦 加拿大 01 [edgetunnel · AWS ca-central-1] | `theecyezvuzkflwikxwr.supabase.co` | `21a1f940...` | `supabase-sb1-singapore-v15(ca-central-1)` | `HTTP 204` | 2471.7 | `15.223.199.169` | `AS16509 Amazon.com, Inc.` | `CA` | `CA` | **PASS (MATCH)** |
| 15 | 🇫🇷 法国巴黎 01 [Wasmer · OVH AS16276] | `w-fr.ruoyemu.asia` | `78174327...` | `wasmer-edgetunnel-fr (AS16276 OVH Paris)` | `HTTP 204` | 2461.4 | `91.134.68.236` | `AS16276 OVH SAS` | `FR` | `FR` | **PASS (MATCH)** |
| 16 | 🇦🇺 澳大利亚 01 [edgetunnel · AWS ap-southeast-2] | `theecyezvuzkflwikxwr.supabase.co` | `21a1f940...` | `supabase-sb1-singapore-v15(ap-southeast-2)` | `HTTP 204` | 4796.1 | `52.63.75.58` | `AS16509 Amazon.com, Inc.` | `AU` | `AU` | **PASS (MATCH)** |
| 17 | 🇫🇷 法国巴黎 03 [edgetunnel · AWS eu-west-3] | `theecyezvuzkflwikxwr.supabase.co` | `21a1f940...` | `supabase-sb1-singapore-v15(eu-west-3)` | `HTTP 204` | 4337.2 | `51.44.85.179` | `AS16509 Amazon.com, Inc.` | `FR` | `FR` | **PASS (MATCH)** |
| 18 | 🇩🇪 德国法兰克福 03 [edgetunnel · AWS eu-central-1] | `theecyezvuzkflwikxwr.supabase.co` | `21a1f940...` | `supabase-sb1-singapore-v15(eu-central-1)` | `HTTP 204` | 3919.5 | `3.70.28.41` | `AS16509 Amazon.com, Inc.` | `DE` | `DE` | **PASS (MATCH)** |
| 19 | 🇺🇸 美国美西 01 [Wasmer · Choopa AS20473] | `w-la.ruoyemu.asia` | `78174327...` | `wasmer-edgetunnel-us-la (AS20473 Choopa/Vultr LA)` | `HTTP 204` | 2757.8 | `66.42.98.41` | `AS20473 The Constant Company, LLC` | `US` | `US` | **PASS (MATCH)** |
| 20 | 🇸🇬 新加坡 03 [edgetunnel · AWS ap-southeast-1] | `theecyezvuzkflwikxwr.supabase.co` | `21a1f940...` | `supabase-sb1-singapore-v15(ap-southeast-1)` | `HTTP 204` | 3226.5 | `13.212.131.104` | `AS16509 Amazon.com, Inc.` | `SG` | `SG` | **PASS (MATCH)** |
| 21 | 🇩🇪 德国法兰克福 02 [edgetunnel · AWS eu-central-1] | `gwgiogtgdyrqlexcdjqm.supabase.co` | `21a1f940...` | `supabase-sb2-tokyo-v5(eu-central-1)` | `HTTP 204` | 2291.2 | `3.121.112.239` | `AS16509 Amazon.com, Inc.` | `DE` | `DE` | **PASS (MATCH)** |
| 22 | 🇯🇵 日本东京 03 [edgetunnel · AWS ap-northeast-1] | `theecyezvuzkflwikxwr.supabase.co` | `21a1f940...` | `supabase-sb1-singapore-v15(ap-northeast-1)` | `HTTP 204` | 2452.5 | `18.182.39.18` | `AS16509 Amazon.com, Inc.` | `JP` | `JP` | **PASS (MATCH)** |
